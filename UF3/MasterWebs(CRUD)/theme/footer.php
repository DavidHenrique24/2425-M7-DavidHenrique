        ...
        <div class="col-md-6">
          <div class="bg-white p-4">
            ...
            <form action="#">
              ...
              <input type="text" id="name" name="name" class="form-control mb-4 px-0" placeholder="Dirección de correo electrónico">
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-6 text-center text-md-left">
          <p class="text-light mb-0">Copyright &copy; 2019 un tema de <a class="text-gradient-primary" href="https://themefisher.com">themefisher.com</a></p>
        </div>
        <div class="col-md-6">
